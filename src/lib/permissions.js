...
export const PERMESSI_DEFAULT = {
  ...
  responsabile_tecnico: ["rapportini", "cantieri", "foto", "anagrafe", "trasferte", "programma", "cronoprogramma", "documenti", "corsi"],
  capocantiere: ["rapportini", "cantieri", "foto", "anagrafe", "trasferte", "furgoni", "idropulitrice"],
