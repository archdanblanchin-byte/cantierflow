...
const LABEL_BOTTONE = {
  ingresso: "Avvia lavoro in cantiere",
  uscita: "Chiudi lavoro in cantiere",
  pausa_inizio: "Inizia pausa pranzo",
  pausa_fine: "Fine pausa pranzo",
};
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-[11px] text-center text-muted-foreground">
        Registra automaticamente orario e posizione GPS. Lo spostamento tra due cantieri viene ricavato dall'intervallo tra la chiusura e la nuova apertura.
      </p>
