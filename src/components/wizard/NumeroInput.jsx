...
/**
 * Input numerico generico (contatori, quantità) con:
 * - scatti di `step` (default 0,25 per le quantità; passo 1 per i contatori)
 ...
 * NB: per le ORE usare OreInput (formato ore + minuti).
 */
export default function NumeroInput({ value, onChange, step = 0.25, min = 0, className, disabled, compact = false }) {
